...
{ // TODO: Make this and exercise one function
...
char *exercises_to_json()
{ // TODO: Make this and programs one function
    char *result = (char *)malloc(sizeof(char) * 2048);
    memset(result, 0, sizeof(char) * 2048);
    for (size_t i = 0; i < exercises_count; i++)
    {
...
/* static */ void event_handler(struct mg_connection *c, int ev, void *ev_data)
{
    ...
    else if (ev == MG_EV_HTTP_MSG)
    {
        ...
        else if (mg_http_match_uri(hm, "/api/new_file"))
        {
            struct mg_str json = hm->body;
            /* if (update_file(json, 0) != 0) {
                printf("Error updating the file\n");
...
// TODO: make add and delete program files
// TODO: virtual queue  to use the site
// TODO: Separate all the funcions in different files
int main(void)
{
